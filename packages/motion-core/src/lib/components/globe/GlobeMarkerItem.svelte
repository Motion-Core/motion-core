...
>
	...
	{#if marker.label}
		...
		>
			<div
				class="pointer-events-none absolute -top-6 left-1/2 -translate-x-1/2 rounded bg-fixed-dark/80 px-2 py-1 text-xs whitespace-nowrap text-fixed-light backdrop-blur-sm transition-opacity duration-200"

...
<a
	...
	{...rest}
	class={cn(
		"relative group flex flex-col rounded-md border border-border bg-card px-4 py-3 shadow-sm transition-[background-color] duration-150 ease-out hover:bg-card-muted",

...
<button
	type="button"
	class={cn(
		"group card-highlight relative flex h-9 w-full items-center gap-2 rounded-xl border border-border bg-background px-3 py-1.5 text-sm text-foreground/45 transition-[color] duration-150 ease-out hover:text-foreground/70",
		className,
	)}

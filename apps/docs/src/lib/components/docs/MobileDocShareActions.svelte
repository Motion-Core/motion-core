	...
	<div class="relative">
		...
		{#if isDropdownOpen}
			<div
				...
				style={dropdownStyle}
				class="card-highlight z-50 flex w-48 origin-top-right flex-col gap-0.5 rounded-xl bg-card p-1 shadow-lg"
			...
			>
				<a
					...
					target="_blank"
					rel="noreferrer"
					class="group flex w-full items-center gap-2 rounded-lg px-2 py-1.5 text-sm text-foreground/70 transition-colors hover:bg-card-muted hover:text-foreground"
				>
					<svg
						role="img"
						viewBox="0 0 24 24"

...
{:else}
	<div
		class="card-highlight relative inline-block w-fit rounded-lg bg-card px-1.5 py-0.5 text-xs font-medium whitespace-nowrap text-foreground shadow-sm mono"
	>

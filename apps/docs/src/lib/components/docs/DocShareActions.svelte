...
<div class="mt-auto">
	<div class="flex flex-col gap-1 text-sm">
		<button
			...
			class="group/option flex items-center gap-2 text-left text-foreground/70 hover:text-foreground py-1.5 px-3 rounded-md hover:bg-card-muted transition-colors duration-150 ease-out overflow-hidden"
		>
		...
		<a
			class="group/option flex items-center gap-2 text-left text-foreground/70 hover:text-foreground py-1.5 px-3 rounded-md hover:bg-card-muted transition-colors duration-150 ease-out"
			href={githubUrl}
			target="_blank"
			rel="noreferrer"
		>
